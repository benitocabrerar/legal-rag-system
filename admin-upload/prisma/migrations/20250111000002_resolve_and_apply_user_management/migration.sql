-- Resolve the failed migration by removing it from the _prisma_migrations table
-- This allows us to apply new migrations
DELETE FROM "_prisma_migrations" WHERE "migration_name" = '20250111000000_user_management_system';

-- Add user management system tables and fields

-- Add new fields to users table (excluding columns that already exist)
