...
export const TOURS: Record<string, Tour> = {
  ...
  'documents-lifecycle': {
    ...
    label: 'Tour del ciclo de vida de documentos',
    steps: [
      { title: '📑 Documentos con kind',
        body: 'Cada documento del expediente tiene un tipo (kind) que la IA usa para razonar. Te muestro los 4 estados y cómo se transita entre ellos.',
        placement: 'center' },
      { title: 'uploaded (indigo)',
        body: 'Lo que subís vos: providencias, contratos, evidencia, escritos de contraparte. Badge índigo con ícono de documento. La IA lo trata como fuente de verdad.',
        placement: 'center' },
      { title: 'ai_generated (purple)',
        body: 'Borradores producidos por el Generador de Documentos IA. Badge purple con ✨. La IA y demás miembros del estudio los tratan como propuesta, no como verdad oficial.',
        placement: 'center' },
      { title: 'ai_analysis (fucsia)',
        body: 'Análisis o dictámenes IA (Análisis Profundo, Post-Upload, Referencia Legal). Badge fucsia con ✨. Son conclusiones — NO se vectorizan para no contaminar la búsqueda.',
        placement: 'center' },
      { title: 'court_filed (esmeralda) ⚖️',
        body: 'Documento ya presentado oficialmente al juzgado. Badge esmeralda con ícono de gavel. La IA le da MÁXIMA prioridad sobre cualquier borrador.',
        placement: 'center' },
      { title: 'Marcar como presentado',
        body: 'Click en el ícono ⚖️ a la derecha de un documento (uploaded/ai_generated). Se abre dialog para indicar juzgado + fecha. El cerebro del caso se recalcula automáticamente.',
        placement: 'center' },
      { title: 'Análisis IA automático',
        body: 'Apenas subís un documento nuevo, la IA produce un análisis: qué aporta, urgencias, plan de trabajo, tareas, normas, riesgos. Se guarda como ai_analysis vinculado al original.',
        placement: 'center' },
    ],
  },

  'specialized-prompts-ia': {
    id: 'specialized-prompts-ia',
    label: 'Tour de prompts IA por categoría',
    steps: [
      { title: '🧩 Prompts Especializados',
        body: 'En la página de detalle, el panel del centro tiene 8 categorías de prompts (Análisis, Redacción, Estrategia, etc) — ahora con generación IA por categoría.',
        placement: 'center' },
      { title: 'Prompts estáticos vs IA',
        body: 'Cada categoría tiene prompts base según el tipo legal. Pero el botón Brain "IA avanzado" a la derecha del título genera 6-10 prompts AVANZADOS específicos al caso.',
        placement: 'center' },
      { title: 'Barra de progreso inline',
        body: 'Al pulsar IA avanzado se expande la categoría y aparece una barra con porcentaje grande, label de fase y pulse overlay. "Generando prompt 4 de ~8…" en tiempo real.',
        placement: 'center' },
      { title: 'Prompts AVANZADOS',
        body: 'Asumen abogado senior · razonamiento multi-paso · terminología precisa (penal/civil/etc) · 3-5 frases mencionando partes, montos, normas reales. Cada uno con un Why explicando relevancia AHORA.',
        placement: 'center' },
      { title: 'Copiar prompt',
        body: 'Mini-botón de copy en cada card (visible al hover) con feedback de check verde 1.5s. Útil para llevarte el prompt a otra herramienta.',
        placement: 'center' },
      { title: 'Re-evaluar etapa procesal',
        body: 'A la izquierda del panel, en Proceso <Tipo>, el botón "Re-evaluar IA" lee los documentos del caso y propone la etapa actual con un rationale breve. Vos aceptás o ignorás.',
        placement: 'center' },
    ],
  },

  'legal-reference-dialog': {
    id: 'legal-reference-dialog',
    label: 'Tour del análisis profundo de normas',
    steps: [
      { title: '⚖️ Referencias Legales clickeables',
        body: 'En la columna derecha, el panel Referencias Legales muestra normas pertinentes. Click en cualquier card y entra el análisis profundo IA.',
        placement: 'center' },
      { title: 'Pipeline de progreso',
        body: 'Mini-timeline con 6 hitos: Contexto → Embedding → RAG → Análisis IA → Estrategia → Listo. Dots verdes para completados, pulsante para el actual, gris para pendientes.',
        placement: 'center' },
      { title: 'RAG real del corpus legal',
        body: '138 leyes ecuatorianas vectorizadas (36.704 chunks). La IA busca top-5 extractos por relevancia semántica+keyword y transcribe el texto literal del artículo.',
        placement: 'center' },
      { title: 'Análisis multinivel',
        body: '12 secciones: texto literal · resumen · análisis jurídico · importancia para tu caso · penas/efectos · requisitos · normas relacionadas · jurisprudencia · estrategia · defensas · errores · fuentes con scores.',
        placement: 'center' },
      { title: 'Importancia para ESTE caso',
        body: 'No es genérico. La IA conecta la norma con hechos, partes, montos y etapa procesal de tu expediente concreto. Como tener un junior senior que te explica por qué importa AHORA.',
        placement: 'center' },
      { title: 'Guardar al expediente',
        body: 'Botón "Guardar al expediente" persiste el análisis como documento del caso con kind ai_analysis. Útil para no regenerar (cada análisis tarda 20-45s y consume tokens).',
        placement: 'center' },
    ],
  },
};
