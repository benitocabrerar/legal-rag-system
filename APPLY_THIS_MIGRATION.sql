...
-- ============================================
SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND (table_name LIKE '%analysis%' OR table_name LIKE '%registry%' OR table_name LIKE '%notification%') ORDER BY table_name;
